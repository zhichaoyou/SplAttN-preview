...
from config_34 import cfg
from core.train_34 import train_net
from core.test_34 import test_net
...
def main():
    ...
    if not args.test and not args.inference:
        ...
        if getattr(cfg.CONST, 'WEIGHTS', None) is None:
